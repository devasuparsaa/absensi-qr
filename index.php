...
// $siswa = "home";
// if(!empty($_GET['siswa'])){$siswa = mysqli_escape_string($connection,@$_GET['siswa']);}
// else {$siswa ='home';}
// if(file_exists("sw-siswa/$siswa.php")){
//     require_once("sw-siswa/$siswa.php");
// }else{
//     require_once("sw-siswa/home.php");
//   }
?>