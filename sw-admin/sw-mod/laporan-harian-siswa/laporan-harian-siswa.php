    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Laporan Harian Absensi Siswa</b></h3>
        </div>
        <div class="box-body">
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              <select class="form-control name" required>
               ...
               $query  ="SELECT nis, nama_siswa from student ORDER BY nis ASC";
...
echo'
<section class="content-header">
  <h1>Data Absensi<small> Siswa</small></h1>
    <ol class="breadcrumb">
      <li><a href="./"><i class="fa fa-dashboard"></i> Beranda</a></li>
...
if(!empty($_GET['nis'])){
    ...
    echo'
<section class="content"><input type="hidden" id="id" value="'.$row['nis'].'" readonly>
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Data Absensi Siswa: '.$row['nama_siswa'].'</b></h3>
