...
case 'pdf':
  if (empty($_GET['nis'])) {
      ...
      $id = mysqli_real_escape_string($connection, $_GET['nis']);
  }

if (empty($error)) {
  $query ="SELECT student.nis,student.nama_siswa,student.id_kelas,class.nama_kelas, class.id_jurusan, major.nama_jurusan FROM student,class,major WHERE student.id_kelas=class.id_kelas AND class.id_jurusan=major.id_jurusan AND student.nis='$id'";
...
<html>
<head>
    <title>Cetak Data Absensi '.$nama_siswa.'</title>
    <style>
...
echo'
    <section class="container_box">
      ...
      if(isset($_GET['from']) OR isset($_GET['to'])){
        ...
        echo'
        <p>NIP     : '.$row['nis'].'</p>
        <p>Nama    : '.$row['nama_siswa'].'</p>
        <p>Kelas & Jurusan : '.$row['nama_kelas'].' '.$row['nama_jurusan'].'</p><br>
      ...
      if(isset($_GET['from']) OR isset($_GET['to'])){
        $month = $_GET['from'];
        $year  = $_GET['to'];
        $filter ="nis='$id' AND presence_date='$date_month_year' AND MONTH(presence_date)='$month' AND year(presence_date)='$year'";
      } 
      else{
        $filter ="nis='$id' AND  presence_date='$date_month_year' AND MONTH(presence_date) ='$month'";
      }
