...
<section class="content-header">
  <h1>Data<small> Absensi Guru</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Laporan Harian Absensi Guru</b></h3>
        </div>
        <div class="box-body">
        <div class="row">
          <div class="col-md-3">
...
echo'
<section class="content-header">
  <h1>Data Absensi<small> Guru</small></h1>
    <ol class="breadcrumb">
      <li><a href="./"><i class="fa fa-dashboard"></i> Beranda</a></li>
...
<section class="content"><input type="hidden" id="id" value="'.$row['id'].'" readonly>
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Data Absensi Guru: '.$row['employees_name'].'</b></h3>
