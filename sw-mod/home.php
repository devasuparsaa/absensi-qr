  ...
  echo'<!-- App Capsule -->
        ...
        <div class="section wallet-card-section pt-1">
            <div class="wallet-card">
                ...
                <div class="wallet-footer">
                    ...
                    <div class="item">
                        <a href="./profile">
                            <div class="icon-wrapper" style="background-color: #ff4ca5;">
                    ...
                    <div class="item">
                        <a href="./jadwal">
                            <div class="icon-wrapper" style="background-color: #0dcaf0;">
                                <ion-icon name="calendar-outline"></ion-icon>
                            </div>
    ...
    <div class="section mt-4">
        <div class="section-title mb-1">Absensi Bulan
            <select class="select select-change text-success" required>';
              ...
              echo'
            </select><span class="text-success">'.$year.'</span>
        </div>
      ...
      <div class="section mt-2 mb-2">
            ...
            <div class="card">
                <div class="table-responsive">
                    <table class="table table-dark rounded bg-info">
                        <thead>
                            <tr>
                        ...
                        <tbody>';
                        $query_absen="SELECT presence_date,time_in,time_out,present_id FROM presence WHERE YEARWEEK(presence_date)=YEARWEEK(NOW()) AND employees_id='$row_user[id]' ORDER BY presence_id DESC LIMIT 6";
                        $result_absen = $connection->query($query_absen);
                        if($result_absen->num_rows > 0){
                            while ($row_absen= $result_absen->fetch_assoc()) {
                                $time_in_display = $row_absen['time_in'];
                                $time_out_display = $row_absen['time_out'];
                                if ($row_absen['present_id'] == '2') {
                                    $time_in_display = 'Sakit';
                                    $time_out_display = 'Sakit';
                                } else if (in_array($row_absen['present_id'], ['3','7'])) {
                                    $time_in_display = 'Izin';
                                    $time_out_display = 'Izin';
                                } else if (in_array($row_absen['present_id'], ['4','5'])) {
                                    $time_in_display = 'Dinas Luar';
                                    $time_out_display = 'Dinas Luar';;
                                } else if ($row_absen['present_id'] == '6' || $row_absen['present_id'] == NULL) {
                                    $time_in_display = 'Alpa';
                                    $time_out_display = 'Alpa';
                                }
                            echo'
                            <tr>
                                ...
                                <td>';
                                if ($row_absen['present_id'] == '1') {
                                    echo 'Hadir';
                                } else if ($row_absen['present_id'] == '2') {
                                    echo 'Sakit';
                                } else if (in_array($row_absen['present_id'], ['3','7'])) {
                                    echo 'Izin';
                                } else if (in_array($row_absen['present_id'], ['4','5'])) {
