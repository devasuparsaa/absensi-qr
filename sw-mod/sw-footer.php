...
<footer class="text-muted text-center d-none" style="display:none">
     &copy; 2022 - '.DATE('Y').' '.$site_name.' | Design With <i class="fa fa-heart"></i> From <a class="credits" id="credits"></a>, Update_<a>Deva_suparsa</a>- All Rights Reserved
</footer>
<!-- ///////////// Js Files ////////////////////  -->
<!-- Jquery -->
